...
function Register() {
  ...
  return (
    <div className='h-fit mt-20 flex justify-center items-center'>
  ...
  <button type="submit" className='p-2 text-center rounded-md mt-4 w-11/12 bg-blue-600 text-white font-semibold  mx-auto hover:bg-blue-700 transition-all ease-in-out mb-4'>Create account</button>
  <p className='text-center flex justify-center gap-1 font-semibold mb-2'>Already have an account?<p onClick={() => navigate('/login')} className='text-blue-600 cursor-pointer hover:text-blue-100'>Log in!</p></p>
